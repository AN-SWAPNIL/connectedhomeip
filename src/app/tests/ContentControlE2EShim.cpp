/**
 * @file ContentControlE2EShim.cpp
 *
 * Minimal shim providing missing symbols for Content Control E2E tests.
 * Provides in-memory attribute storage so the real server can read/write
 * attributes through the standard emberAf Read/Write path.
 */
